<?php
// ============================================================
// index.php — نسخة بدون API
// يجيب البيانات من قاعدة البيانات مباشرة ويضمّها في الصفحة
// بدون أي fetch() منفصل من المتصفح
// ============================================================
...
try {
    $artPDO = new PDO(
        ...
        '?BN0Mn5x$(K$',
        [PDO::ATTR_ERRMODE => PDO::ERRMODE_EXCEPTION, PDO::ATTR_DEFAULT_FETCH_MODE => PDO::FETCH_ASSOC, PDO::MYSQL_ATTR_CONNECT_TIMEOUT => 3]
    );
    $site_data['articles'] = $artPDO->query("
...
// ---- Header/Body code ----
$header_code = $site_data['settings']['header_code'] ?? '';
$body_code   = $site_data['settings']['body_code']   ?? '';
?>
<!doctype html>
<html lang="ar" dir="rtl">
  <head>
    ...
    <noscript><link href="https://fonts.googleapis.com/css2?family=Tajawal:wght@400;700;800&display=swap" rel="stylesheet" /></noscript>
    ...
    <link rel="preload" as="image" href="pattern-1.webp" fetchpriority="high" />
    <link rel="preload" as="image" href="logob.webp" fetchpriority="high" />
    ...
    <!-- Google Tag Manager -->
    <script>
      (function(w,d,s,l,i){w[l]=w[l]||[];w[l].push({'gtm.start':new Date().getTime(),event:'gtm.js'});var f=d.getElementsByTagName(s)[0],j=d.createElement(s),dl=l!='dataLayer'?'&l='+l:'';j.async=true;j.src='https://www.googletagmanager.com/gtm.js?id='+i+dl;f.parentNode.insertBefore(j,f);})(window,document,'script','dataLayer','GTM-WZSZSGPN');
    </script>
    <!-- بيانات الموقع مضمّنة مباشرة — بدون أي fetch() منفصل -->
    <script>window.SITE_DATA = <?php echo json_encode($site_data, JSON_UNESCAPED_UNICODE); ?>;</script>
  </head>
  <body>
    <?php if ($body_code): ?>
    <!-- Dynamic Body Code -->
    ...
    <header id="site-header" class="site-header">
      <div class="header-inner">
        ...
        <nav class="header-nav">
          ...
          <a href="https://wa.me/966920029921" style="padding:0px;margin-bottom:-6px;font-size:19px"><i class="fa-brands fa-whatsapp"></i></a>
    ...
    <section id="hero" class="hero-section">
      <div class="hero-pattern-top">
        <img src="pattern-1.webp" alt="" aria-hidden="true" width="1440" height="400" fetchpriority="high" />
      </div>
      ...
      <div class="hero-content">
        ...
        <div class="hero-stats" id="hero-stats">
          ...
          <div class="stat-divider"></div>
          <div class="stat-item"><span class="stat-num">+ 745 k </span><span class="stat-label">عميل راضي</span></div>
        </div>
      </div>
      <div class="hero-pattern-bottom">
        <img src="pattern-2.webp" alt="" aria-hidden="true" width="1440" height="400" loading="lazy" />
      </div>
    </section>
    <!-- SOCIAL -->
    <section id="social" class="social-section">
      <div class="container">
        ...
        <div class="social-grid" id="social-grid">
          <div class="social-skeleton"></div><div class="social-skeleton"></div><div class="social-skeleton"></div>
          <div class="social-skeleton"></div><div class="social-skeleton"></div><div class="social-skeleton"></div>
        </div>
      </div>
    </section>
    ...
    <section id="branches" class="branches-section">
      <div class="section-pattern-accent">
        <img src="pattern-3.webp" alt="" aria-hidden="true" loading="lazy" />
      </div>
    ...
    <section id="contact" class="contact-section">
      <div class="contact-bg-pattern">
        <img src="pattern-4.webp" alt="" aria-hidden="true" loading="lazy" />
      </div>
      <div class="container">
    ...
    <section id="brands" class="brands-section">
      ...
      <div class="brands-pattern-bottom">
        <img src="pattern-6.webp" alt="" aria-hidden="true" loading="lazy" />
      </div>
    </section>
    <!-- ARTICLES -->
    ...
    <a href="https://wa.me/966920029921" target="_blank" rel="noopener noreferrer" id="whatsapp-float" aria-label="تواصل معنا عبر واتساب"
    ...
    <style>
      ...
      @keyframes whatsapp-pulse{0%{box-shadow:0 0 0 0 rgba(37,211,102,0.5)}70%{box-shadow:0 0 0 14px rgba(37,211,102,0)}100%{box-shadow:0 0 0 0 rgba(37,211,102,0)}}
    </style>
